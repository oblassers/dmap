package at.ac.tuwien.dmap.dmapbackend.tiss.common;

import at.ac.tuwien.dmap.dmapbackend.tiss.common.exceptions.TissErrorResponseException;
...
public class TissResponseErrorHandler implements ResponseErrorHandler {
    ...
    /**
     * In case TISS returns client (4xx) or server errors (5xx) throw a TISS error response exceptions.
     * @param httpResponse
     * @throws IOException
     */
    @Override
